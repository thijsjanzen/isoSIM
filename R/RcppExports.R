...
create_population_selection_twoalleles_cpp <- function(select, pop_size, number_of_founders, total_runtime, morgan, progress_bar, track_frequency) {
    .Call('_isoSIM_create_population_selection_twoalleles_cpp', PACKAGE = 'isoSIM', select, pop_size, number_of_founders, total_runtime, morgan, progress_bar, track_frequency)
}

select_population_twoalleles_cpp <- function(v1, selectM, population_size, run_time, morgan, progress_bar, track_frequency) {
    .Call('_isoSIM_select_population_twoalleles_cpp', PACKAGE = 'isoSIM', v1, selectM, population_size, run_time, morgan, progress_bar, track_frequency)
}
...
select_population_markers_cpp <- function(v1, selectM, population_size, run_time, morgan, progress_bar, track_frequency) {
    .Call('_isoSIM_select_population_markers_cpp', PACKAGE = 'isoSIM', v1, selectM, population_size, run_time, morgan, progress_bar, track_frequency)
}
