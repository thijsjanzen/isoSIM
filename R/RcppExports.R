...
simulate_cpp <- function(input_population, select, pop_size, number_of_founders, total_runtime, morgan, progress_bar, track_frequency, track_junctions) {
    .Call('_isoSIM_simulate_cpp', PACKAGE = 'isoSIM', input_population, select, pop_size, number_of_founders, total_runtime, morgan, progress_bar, track_frequency, track_junctions)
}
