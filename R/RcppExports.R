...
select_population_cpp <- function(v, selectMatrix, s, population_size, run_time, morgan, seed) {
    .Call('_isoSIM_select_population_cpp', PACKAGE = 'isoSIM', v, selectMatrix, s, population_size, run_time, morgan, seed)
}
