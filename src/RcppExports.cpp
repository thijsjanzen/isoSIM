...
List create_population_selection_cpp(NumericMatrix select, int pop_size, int number_of_founders, int total_runtime, double morgan, bool progress_bar, bool track_frequency, const NumericVector& track_markers, bool multiplicative_selection);
RcppExport SEXP _isoSIM_create_population_selection_cpp(SEXP selectSEXP, SEXP pop_sizeSEXP, SEXP number_of_foundersSEXP, SEXP total_runtimeSEXP, SEXP morganSEXP, SEXP progress_barSEXP, SEXP track_frequencySEXP, SEXP track_markersSEXP, SEXP multiplicative_selectionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const NumericVector& >::type track_markers(track_markersSEXP);
    Rcpp::traits::input_parameter< bool >::type multiplicative_selection(multiplicative_selectionSEXP);
    rcpp_result_gen = Rcpp::wrap(create_population_selection_cpp(select, pop_size, number_of_founders, total_runtime, morgan, progress_bar, track_frequency, track_markers, multiplicative_selection));
    return rcpp_result_gen;
END_RCPP
}
// select_population_cpp
List select_population_cpp(Rcpp::NumericVector v1, Rcpp::NumericMatrix selectM, int population_size, int run_time, double morgan, bool progress_bar, bool track_frequency, const NumericVector track_markers, bool multiplicative_selection);
RcppExport SEXP _isoSIM_select_population_cpp(SEXP v1SEXP, SEXP selectMSEXP, SEXP population_sizeSEXP, SEXP run_timeSEXP, SEXP morganSEXP, SEXP progress_barSEXP, SEXP track_frequencySEXP, SEXP track_markersSEXP, SEXP multiplicative_selectionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const NumericVector >::type track_markers(track_markersSEXP);
    Rcpp::traits::input_parameter< bool >::type multiplicative_selection(multiplicative_selectionSEXP);
    rcpp_result_gen = Rcpp::wrap(select_population_cpp(v1, selectM, population_size, run_time, morgan, progress_bar, track_frequency, track_markers, multiplicative_selection));
    return rcpp_result_gen;
END_RCPP
}
// simulate_cpp
