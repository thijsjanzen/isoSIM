...
selected_pop <- create_population_selection_markers(pop_size = 1000,
                                  number_of_founders = 4, 
                                  total_runtime = 1000,
                                  morgan = 1,
...
selected_pop <- select_population_markers(wildpop, 
                                          selection_matrix,
                                  pop_size = 1000,
                                  total_runtime = 1000,
                                  morgan = 1,
...
selection_matrix[2,] = c(0.78, 0.8, 4)
...
freq_output <- calculate_allele_frequencies(selected_pop_2, 
                                            step_size = 0.01)
