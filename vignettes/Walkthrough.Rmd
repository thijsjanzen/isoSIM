...
```{r selection}
number_founders = 20
wildpop =  create_full_population(pop_size = 1000, 
...
selectionMatrix = matrix(ncol=3, nrow = 2)

selectionMatrix[1,] = c(0.2, 0.3, 1)
selectionMatrix[2,] = c(0.6, 0.7, 2)
...
selected_pop <- select_population(wildpop, selectionMatrix,
