...
mixed_population <- create_population_from_individuals(list(isofemale_1[[1]], isofemale_2[[1]]),
...
LD_results <- isoSIM::calculate_LD(strong_LD_pop, sampled_individuals = 100,
                                  number_of_markers = 10, random_markers = TRUE)
