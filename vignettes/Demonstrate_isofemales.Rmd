...
pop_1 <- simulate_admixture(pop_size = 100, number_of_founders = 4, total_runtime = 1000, morgan = 1, seed = 42)
pop_2 <- simulate_admixture(pop_size = 100, number_of_founders = 4, total_runtime = 1000, morgan = 1, seed = 666)
